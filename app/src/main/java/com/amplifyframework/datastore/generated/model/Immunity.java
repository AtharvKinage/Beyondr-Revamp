...
/** This is an auto generated class representing the Immunity type in your schema. */
@SuppressWarnings("all")
@ModelConfig(pluralName = "Immunities", authRules = {
...
@Index(name = "byImmunity", fields = {"UserID"})
@Index(name = "byImmunitydoc", fields = {"DoctorsID"})
public final class Immunity implements Model {
  public static final QueryField ID = field("Immunity", "id");
  public static final QueryField NAME = field("Immunity", "name");
  public static final QueryField DOCTORS_ID = field("Immunity", "DoctorsID");
  public static final QueryField MEEETINGID = field("Immunity", "meeetingid");
  public static final QueryField USER_ID = field("Immunity", "UserID");
  public static final QueryField DOSAGE = field("Immunity", "dosage");
  public static final QueryField INSTRUCTION = field("Immunity", "instruction");
  public static final QueryField REASON = field("Immunity", "reason");
  ...
  private Immunity(String id, String name, String DoctorsID, String meeetingid, String UserID, String dosage, String instruction, String reason) {
    this.id = id;
    this.name = name;
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      Immunity immunity = (Immunity) obj;
      return ObjectsCompat.equals(getId(), immunity.getId()) &&
              ObjectsCompat.equals(getName(), immunity.getName()) &&
              ObjectsCompat.equals(getDoctorsId(), immunity.getDoctorsId()) &&
              ObjectsCompat.equals(getMeeetingid(), immunity.getMeeetingid()) &&
              ObjectsCompat.equals(getUserId(), immunity.getUserId()) &&
              ObjectsCompat.equals(getDosage(), immunity.getDosage()) &&
              ObjectsCompat.equals(getInstruction(), immunity.getInstruction()) &&
              ObjectsCompat.equals(getReason(), immunity.getReason());
      }
  }
   ...
   */
  public static Immunity justId(String id) {
    try {
