...
/** This is an auto generated class representing the PaymentforWallet type in your schema. */
@SuppressWarnings("all")
@ModelConfig(pluralName = "PaymentforWallets")
public final class PaymentforWallet implements Model {
  public static final QueryField ID = field("PaymentforWallet", "id");
  public static final QueryField AMOUNT = field("PaymentforWallet", "amount");
  public static final QueryField CURRENCY = field("PaymentforWallet", "currency");
  public static final QueryField DATE = field("PaymentforWallet", "date");
  public static final QueryField PAYMENTFROM = field("PaymentforWallet", "paymentfrom");
  ...
  private PaymentforWallet(String id, String amount, String currency, Temporal.DateTime date, String paymentfrom) {
    this.id = id;
    this.amount = amount;
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      PaymentforWallet paymentforWallet = (PaymentforWallet) obj;
      return ObjectsCompat.equals(getId(), paymentforWallet.getId()) &&
              ObjectsCompat.equals(getAmount(), paymentforWallet.getAmount()) &&
              ObjectsCompat.equals(getCurrency(), paymentforWallet.getCurrency()) &&
              ObjectsCompat.equals(getDate(), paymentforWallet.getDate()) &&
              ObjectsCompat.equals(getPaymentfrom(), paymentforWallet.getPaymentfrom());
      }
  }
   ...
   */
  public static PaymentforWallet justId(String id) {
    try {
